...
//void Shader::Destroy()
//{
//	//if (_globalEffectBuffer)
//	//	_globalEffectBuffer->SetConstantBuffer(nullptr);
//	//if (_transformEffectBuffer)
//	//	_transformEffectBuffer->SetConstantBuffer(nullptr);
//	//if (_lightEffectBuffer)
//	//	_lightEffectBuffer->SetConstantBuffer(nullptr);
//	//if (_materialEffectBuffer)
//	//	_materialEffectBuffer->SetConstantBuffer(nullptr);
//	//if (_boneEffectBuffer)
//	//	_boneEffectBuffer->SetConstantBuffer(nullptr);
//	//if (_tweenEffectBuffer)
//	//	_tweenEffectBuffer->SetConstantBuffer(nullptr);
//
//	
//
//}
