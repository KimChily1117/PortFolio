...
enum PLAYER_CHAMPION_TYPE : int {
  PLAYER_TYPE_NONE = 0,
  PLAYER_TYPE_ANNIE = 1,
  PLAYER_TYPE_GAREN = 2,
  PLAYER_CHAMPION_TYPE_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  PLAYER_CHAMPION_TYPE_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool PLAYER_CHAMPION_TYPE_IsValid(int value);
constexpr PLAYER_CHAMPION_TYPE PLAYER_CHAMPION_TYPE_MIN = PLAYER_TYPE_NONE;
constexpr PLAYER_CHAMPION_TYPE PLAYER_CHAMPION_TYPE_MAX = PLAYER_TYPE_GAREN;
constexpr int PLAYER_CHAMPION_TYPE_ARRAYSIZE = PLAYER_CHAMPION_TYPE_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* PLAYER_CHAMPION_TYPE_descriptor();
template<typename T>
inline const std::string& PLAYER_CHAMPION_TYPE_Name(T enum_t_value) {
  static_assert(::std::is_same<T, PLAYER_CHAMPION_TYPE>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function PLAYER_CHAMPION_TYPE_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    PLAYER_CHAMPION_TYPE_descriptor(), enum_t_value);
}
inline bool PLAYER_CHAMPION_TYPE_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PLAYER_CHAMPION_TYPE* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<PLAYER_CHAMPION_TYPE>(
    PLAYER_CHAMPION_TYPE_descriptor(), name, value);
}
...
constexpr OBJECT_TYPE OBJECT_TYPE_MIN = UNKNOWN;
constexpr OBJECT_TYPE OBJECT_TYPE_MAX = TOWER;
...
template <> struct is_proto_enum< ::Protocol::PLAYER_CHAMPION_TYPE> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::PLAYER_CHAMPION_TYPE>() {
  return ::Protocol::PLAYER_CHAMPION_TYPE_descriptor();
}
