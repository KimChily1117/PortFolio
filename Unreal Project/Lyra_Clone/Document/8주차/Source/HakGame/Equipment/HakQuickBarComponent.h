...
class UHakEquipmentManagerComponent;
 ...
 */
UCLASS()
class HAKGAME_API UHakQuickBarComponent : public UControllerComponent
{
	GENERATED_BODY()
public:
	...
	* member methods
	*/
	UHakEquipmentManagerComponent* FindEquipmentManager() const;
