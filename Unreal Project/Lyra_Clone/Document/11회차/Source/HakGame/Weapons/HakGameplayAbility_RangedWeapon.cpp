...
#include "HakRangedWeaponInstance.h"
#include "Engine/World.h"
#include "GameFramework/Pawn.h"
#include "GameFramework/PlayerController.h"
#include "HakGame/AbilitySystem/HakGameplayAbilityTargetData_SingleTarget.h"
#include "HakGame/Physics/HakCollisionChannels.h"

UHakGameplayAbility_RangedWeapon::UHakGameplayAbility_RangedWeapon(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}
...
FHitResult UHakGameplayAbility_RangedWeapon::DoSingleBulletTrace(const FVector& StartTrace, const FVector& EndTrace,
...
ECollisionChannel UHakGameplayAbility_RangedWeapon::DetermineTraceChannel(FCollisionQueryParams& TraceParams,
