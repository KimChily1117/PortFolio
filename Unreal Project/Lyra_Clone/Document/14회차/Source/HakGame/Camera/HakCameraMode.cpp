...
UHakCameraMode::UHakCameraMode(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	FieldOfView = HAK_CAMERA_DEFAULT_FOV;
...
FVector UHakCameraMode::GetPivotLocation() const
{
...
AActor* UHakCameraMode::GetTargetActor() const
{
...
void UHakCameraModeStack::BlendStack(FHakCameraModeView& OutCameraModeView) const
{
	...
	const UHakCameraMode* CameraMode = CameraModeStack[StackSize - 1];
	check(CameraMode);
