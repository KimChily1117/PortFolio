...
const FName UHakPawnExtensionComponent::NAME_ActorFeatureName("PawnExtension");

UHakPawnExtensionComponent::UHakPawnExtensionComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void UHakPawnExtensionComponent::SetupPlayerInputComponent()
{
