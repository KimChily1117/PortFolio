...
#include "HakAssetManager.generated.h"

/**
 * 
 */
UCLASS()
class HAKGAME_API UHakAssetManager : public UAssetManager
{
	GENERATED_BODY()
public:
	UHakAssetManager();
...
template <typename AssetType>
AssetType* UHakAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepsInMemory)
{
...
template <typename AssetType>
TSubclassOf<AssetType> UHakAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
