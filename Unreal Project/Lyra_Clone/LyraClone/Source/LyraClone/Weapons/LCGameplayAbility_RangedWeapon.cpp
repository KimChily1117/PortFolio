...
void ULCGameplayAbility_RangedWeapon::StartRangedWeaponTargeting()
{
...
void ULCGameplayAbility_RangedWeapon::PerformLocalTargeting(TArray<FHitResult>& OutHits)
{
...
FTransform ULCGameplayAbility_RangedWeapon::GetTargetingTransform(APawn* SourcePawn, ELyraCloneAbilityTargetingSource Source)
{
	check(SourcePawn);
...
FVector ULCGameplayAbility_RangedWeapon::GetWeaponTargetingSourceLocation() const
{
...
void ULCGameplayAbility_RangedWeapon::TraceBulletsInCartridge(const FRangedWeaponFiringInput& InputData, TArray<FHitResult>& OutHits)
{
...
FHitResult ULCGameplayAbility_RangedWeapon::DoSingleBulletTrace(const FVector& StartTrace, const FVector& EndTrace, float SweepRadius, bool bIsSimulated, TArray<FHitResult>& OutHits) const
{
	FHitResult Impact;
...
FHitResult ULCGameplayAbility_RangedWeapon::WeaponTrace(const FVector& StartTrace, const FVector& EndTrace, float SweepRadius, bool bIsSimulated, TArray<FHitResult>& OutHitResults) const
{
...
ECollisionChannel ULCGameplayAbility_RangedWeapon::DetermineTraceChannel(FCollisionQueryParams& TraceParams, bool bIsSimulated) const
{
	return ECC_GameTraceChannel2;
}

void ULCGameplayAbility_RangedWeapon::AddAdditionalTraceIgnoreActors(FCollisionQueryParams& TraceParams) const
{
...
void ULCGameplayAbility_RangedWeapon::OnTargetDataReadyCallback(const FGameplayAbilityTargetDataHandle& InData, FGameplayTag ApplicationTag)
{
...
ULyraCloneRangedWeaponInstance* ULCGameplayAbility_RangedWeapon::GetWeaponInstance()
{
