...
#include "LyraCloneAbilityCost_ItemTagStack.h"
...
ULyraCloneAbilityCost_ItemTagStack::ULyraCloneAbilityCost_ItemTagStack() : Super()
{
...
bool ULyraCloneAbilityCost_ItemTagStack::CheckCost(const ULyraCloneGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
{
	...
	if (const ULCGameplayAbility_FromEquipment* EquipmentAbility = Cast<const ULCGameplayAbility_FromEquipment>(Ability))
	{
